...
class BaseViewController: BEViewController {
    ...
    override func setUp() {
        ...
        if #available(iOS 11, *) {
            ...
            let bottomConstraint = AvoidingKeyboardLayoutConstraint(item: view.bottomAnchor, attribute: .bottom, relatedBy: .equal, toItem: scrollView, attribute: .bottom, multiplier: 1.0, constant: 16)
